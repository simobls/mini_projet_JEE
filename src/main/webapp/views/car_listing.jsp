        ...
        <div class="content">
            ...
            <form method="post" action="../Search" method="post" class="form1">
                ...
                <div class="form">
                    <div class="input">
                          <p>Pickup location</p>
                        <select name="pickupLocation" placeholder="Enter your location" required>
    ...
    <section class="car_listing">
        ...
        <% 
			...
			if (locationId != null && startDate != null && endDate != null) {
			    cars = Car.getAvailableCars(locationId, startDate, endDate);
			    if (cars.isEmpty()) {
			        %>
			        <p>Aucune voiture disponible pour la période sélectionnée.</p>
			        <%
			    }
			} else {
			    cars = Car.getAllCars();
