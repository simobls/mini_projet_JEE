...
<body>
    <section class="hero">
        ...
        <div class="content">
            ...
            <form method="post" action="../Search" method="post" class="form1">
                ...
                <div class="form">
                    ...
                    <div class="input">
					    <p>Pickup date</p>
					    <input id="pickupDate" type="date"  onchange="updateDropoffMinDate()" name="dateDebut" required>
					    <script>
					...
					<div class="input">
					    <p>Dropoff date</p>
					    <input id="dropoffDate" type="date" name="dateFin" required>
					</div>
                </div>
    ...
    List<Car> cars = Car.getAllCars();
		...
		<div class="cars">
		    ...
		    for (Car car : cars) {
		        if (i < 6) {
		            if(user != null) {%>
					<a href="reservations.jsp?id=<%= car.getId() %>" >
					<div class="car">
		                <div class="pic">
		...
		%>
		    ...
		    <section class="brands">
		        <div><img src="../assets/17-bmw-car-logo-png-brand-image.png" width="auto" height="60vh"></div>
		        <div><img src="../assets/3-2-toyota-logo-png-clipart.png" width="auto" height="80vh"></div>
		        <div><img src="../assets/6-mini-car-logo-png-brand-image.png" width="auto" height="50vh"></div>
		        <div><img src="../assets/9-jeep-car-logo-png-brand-image.png" width="auto" height="50vh"></div>
		        <div><img src="../assets/12-jaguar-car-logo-png-brand-image.png" width="auto" height="70vh"></div>
		        <div><img src="../assets/audi-logo-2.png" width="auto" height="70vh"></div>
		        <div><img src="../assets/2-alfa-romeo-car-logo-png-brand-image.png" width="auto" height="70vh"></div>
		    </section>
		    <section class="infos">
		        <div class="info_1">
		    ...
		    <footer>
		        <div class="footer_1">
		            <div class="footer_1_1">
		                ...
		                <p>Northstar Car Rentals in Morocco offers a range of vehicles for travelers, ensuring a comfortable and reliable rental experience.</p>
		            </div>
